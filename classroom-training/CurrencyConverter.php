...
class CurrencyConverter {
   ...
   var $xml_file = "http://www.xe.com/datafeed/samples/sample-xml-usd.xml";
  // var $xml_file = "www.ecb.int/stats/eurofxref/eurofxref-daily.xml";
   ...
   function convert($amount=1,$from="GBP",$to="USD") {
 ...
 //return(number_format(($amount/$this->exchange_rates[$from])*$this->exchange_rates[$to],$decimals));
   ...
   function createTable() {
     ...
     // $sql = "INSERT INTO ".$this->mysql_table." VALUES('USD',1)";
