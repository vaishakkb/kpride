            		...
            		<table class="table table-bordered text-center">
	                	<thead>
	                		<tr>
		                    	...
		                    	?>
		                        <th colspan="1"></th>
		                        <th colspan="3" align="center">Country : <span style="font-weight:bold;color:green;"><em><a href="pmp?country=<?php echo str_replace(' ', '', $q); ?>"><?php echo $q; ?></a></em></span></th><th colspan="2" align="center">City: <em><span style="font-weight:bold;color:green;"><?php echo $r; ?></em></span></th><th colspan="5" align="center">Course: <em><span style="font-weight:bold;color:green;"><?php echo $s; ?></em></span></th>
		                        <?php } ?>
	                    	</tr>	
	                  		<tr>
			                    <th>Date</th>
	                	...
	                	<tbody>
							...
							?>
		          			<tr>
			                    ...
			                    <td><a href="pmp/project-management-professional-training-<?php echo str_replace(' ', '', $rows['City']); ?>-<?php echo str_replace(' ', '', $q); ?>"><?php echo $rows['City'] ?></a></td>
						  ...
						  {
							 echo'<tr><td colspan="9" style="text-align:center;font-weight:bold;color:red;">No Workshop Scheduled! for 3<sup>rd</sup> quarter of 2016<br><br><span style="font-weight:bold;color:green;">Contact Us @ <a href="mailto:support@bestcareerleap.com">support@bestcareerleap.com</a> for Group Nomination</span></td></tr>';
						  }
						   ?>
                		</tbody>
              		</table>
